    ...
    def generate_study_kit(self, resource, context: str = '', page_image_map: dict = None, vision_data: list = None, page_count: int = 0) -> dict:
        ...
        for idx, chunk_text in enumerate(chunks[:25]):
            ...
            prompt = (
                ...
                "- EVERY section 'content' MUST start with a bolded **Key Question:** then IMMEDIATELY follow with 4-6 detailed paragraphs of actual educational content.\n"
                "- DO NOT stop after the Key Question. The content field must contain the FULL explanation, mechanisms, examples, and clinical/practical relevance.\n"
                "- Minimum 300 words per section content. Sections with less than 100 words will be rejected.\n"
