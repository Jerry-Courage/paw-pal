    ...
    def generate_study_kit(self, resource, context: str = '', page_image_map: dict = None, vision_data: list = None, page_count: int = 0) -> dict:
        ...
        for idx, chunk_text in enumerate(chunks[:30]):
            ...
            prompt = (
                ...
                "=== ASCII ART (ChatGPT-QUALITY — when the concept is visual) ===\n"
                "Include an ascii_art field for: graphs, diagrams, circuits, cell anatomy, cycles, process flows, "
                "molecular structures, memory hierarchies, algorithm traces, data structures, physics setups.\n\n"
                "QUALITY RULES:\n"
                "- Use box-drawing: ─ │ ┌ ┐ └ ┘ ╱ ╲ ▲ ● ◆ → ← ↑ ↓ █ ░ ▓ ▒\n"
                "- Label EVERY axis, part, and region (like ChatGPT does)\n"
                "- Use arrows → to show direction/flow\n"
                "- Add region labels: OHMIC, SATURATION, pinch-off, etc.\n"
                "- Make it WIDE enough to be readable (40-60 chars wide)\n"
                "- Include a TITLE line above the diagram\n"
                "- Add short annotations like '← tiny' or '→ output'\n\n"
                "GOOD EXAMPLE (JFET curve):\n"
                "      ID\n"
                "      ↑\n"
                "      │            ┌───────────── SATURATION\n"
                "      │           ╱\n"
                ...
                "     OHMIC/TRIODE    ↑\n"
                "                   pinch-off\n\n"
                "GOOD EXAMPLE (Channel pinch-off):\n"
                "         D\n"
                "         │\n"
                "    ░░░░░░░░░\n"
                "    ▓▓▓▓▓▓▓▓▓  ← tiny\n"
                ...
                "   * ** *\n"
                "    *  *\n"
                "^^^ This is decorative, not educational. Labels > decoration.\n\n"
