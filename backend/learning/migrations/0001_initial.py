    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateTimeField(blank=True, help_text='When to start studying', null=True)),
                ('deadline', models.DateTimeField(blank=True, help_text='When the exam/goal is due', null=True)),
