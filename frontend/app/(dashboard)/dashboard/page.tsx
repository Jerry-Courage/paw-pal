...
export default function DashboardPage() {
  ...
  return (
          ...
          <div className="bg-surface-container-low rounded-[2rem] p-stack-md border border-outline-variant/20">
            <h3 className="text-[13px] font-bold text-on-surface-variant uppercase tracking-widest mb-3 flex items-center gap-base">
              <span className="material-symbols-outlined text-[16px] text-primary-container" style={{ fontVariationSettings: "'FILL' 1" }}>leaderboard</span>
              Rankings
            </h3>

            {/* 3-board teasers */}
            <div className="space-y-2 mb-3">
              <div className="flex items-center gap-2 px-3 py-2.5 rounded-[1rem] bg-emerald-500/8 border border-emerald-500/20">
                <span className="material-symbols-outlined text-[15px] text-emerald-400" style={{ fontVariationSettings: "'FILL' 1" }}>school</span>
                <div className="flex-1 min-w-0">
                  <p className="text-[12px] font-bold text-emerald-400 leading-none">Study XP</p>
                  <p className="text-[10px] text-on-surface-variant">Earned by studying only</p>
                </div>
                <span className="text-[11px] font-black text-emerald-400">{totalXp.toLocaleString()}</span>
              </div>

              <div className="flex items-center gap-2 px-3 py-2.5 rounded-[1rem] bg-yellow-400/8 border border-yellow-400/20">
                <span className="material-symbols-outlined text-[15px] text-yellow-400" style={{ fontVariationSettings: "'FILL' 1" }}>star</span>
                <div className="flex-1 min-w-0">
                  <p className="text-[12px] font-bold text-yellow-400 leading-none">Total XP</p>
                  <p className="text-[10px] text-on-surface-variant">Includes purchased XP packs</p>
                </div>
                <span className="text-[11px] font-black text-yellow-400">—</span>
              </div>

              <div className="flex items-center gap-2 px-3 py-2.5 rounded-[1rem] bg-orange-500/8 border border-orange-500/20">
                <span className="material-symbols-outlined text-[15px] text-orange-400" style={{ fontVariationSettings: "'FILL' 1" }}>local_fire_department</span>
                <div className="flex-1 min-w-0">
                  <p className="text-[12px] font-bold text-orange-400 leading-none">Streaks</p>
                  <p className="text-[10px] text-on-surface-variant">Consecutive study days</p>
                </div>
                <span className="text-[11px] font-black text-orange-400">—</span>
              </div>
            </div>

            <Link href="/rankings" className="w-full flex items-center justify-center gap-2 bg-primary-container text-on-primary-container font-bold text-[13px] py-2.5 rounded-[1rem] hover:brightness-110 transition-all btn-squishy">
